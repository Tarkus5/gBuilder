...
export class FinalizeComponent implements OnInit {
  ...
  getElementiChitarra() { //metodo per la get, con la rimozione degli apici
  ...
  next() { //scrittura delle stringhe senza apici con reindirizzamento

    this.body = localStorage.setItem('Body', this.body);
    this.legnoBody = localStorage.setItem('LegnoBody', this.legnoBody);
    this.legnoTastiera = localStorage.setItem('LegnoTastiera', this.legnoTastiera);
    ...
    this.palettaInTinta = localStorage.setItem('Paletta in Tinta', this.palettaInTinta);
