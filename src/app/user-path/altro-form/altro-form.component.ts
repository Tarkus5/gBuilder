...
import { LuthierRegistrationServiceService } from '../../luthier-path/service/luthier-registration-service.service';
...
export class AltroFormComponent {
  ...
  constructor(private localStorage: LocalStorageService, private router: Router, private http: HttpClient, private formDataService: LuthierRegistrationServiceService) { }
